package com.company; /**
 * com.company.Matrix Algebra over an 8-bit com.company.Galois Field
 *
...
/**
 * A matrix over the 8-bit com.company.Galois field.
 *
...
public class Matrix {
    ...
    private void gaussianElimination() {
        ...
        for (int r = 0; r < rows; r++) {
            ...
            if (data[r][r] == (byte) 0) {
                throw new IllegalArgumentException("com.company.Matrix is singular");
            }
            // Scale to 1.
            if (data[r][r] != (byte) 1) {
            ...
            // both exclusive or in the com.company.Galois field.)
            for (int rowBelow = r + 1; rowBelow < rows; rowBelow++) {
